...
void ds1307_SetHour(unsigned char hh,unsigned char format);
...
void ds1307_GetTime(unsigned char *h_ptr,unsigned char *m_ptr,unsigned char *s_ptr, unsigned char *format);
void ds1307_GetDate(unsigned char *d_ptr,unsigned char *m_ptr,unsigned char *y_ptr,unsigned char *day_ptr);
...
/*Function to Set time hours only in any format*/
void ds1307_SetHour(unsigned char hh,unsigned char format)
{
...
void ds1307_GetDate(unsigned char *d_ptr,unsigned char *m_ptr,unsigned char *y_ptr,unsigned char *day_ptr)
{
	...
	*day_ptr = I2C_dataread();     //Directly taking hex value of day i.e No need for for conversion (always a single digit value)
	I2C_Ack();
